...
namespace HumbugBox400\Composer\Semver;

use HumbugBox400\Composer\Semver\Constraint\Constraint;
use HumbugBox400\Composer\Semver\Constraint\ConstraintInterface;
use HumbugBox400\Composer\Semver\Constraint\MatchAllConstraint;
use HumbugBox400\Composer\Semver\Constraint\MatchNoneConstraint;
use HumbugBox400\Composer\Semver\Constraint\MultiConstraint;
class Intervals
{
    /**
    @phpstan-var
