...
namespace HumbugBox400\Composer;

use HumbugBox400\Composer\Autoload\ClassLoader;
use HumbugBox400\Composer\Semver\VersionParser;
    ...
    */
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('HumbugBox400\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
